...
//	public static String SELECT_DEVICES_WITH_SERIALNUMBER = "FROM Device WHERE serialNumber LIKE '%%s%'";
//	public static String SELECT_DEVICES_WITH_SERIALNUMBER = "FROM Device WHERE serialNumber='%s'";
